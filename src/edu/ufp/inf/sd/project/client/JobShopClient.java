...
public class JobShopClient {
    ...
    private void menu(SessionInfo sessionInfo) throws RemoteException {
        ...
        while (this.factoryRI.getDb().getSessions().containsKey(sessionInfo.getUsername())) {
            ...
            switch (opt) {
                ...
                case "1":
                    ...
                    if (opt2.compareTo("1") == 0 || opt2.compareTo("2") == 0) {
                        ...
                        credits = this.factoryRI.getDb().getUser(sessionInfo.getUsername()).getCredits();
                    }
                    System.out.println();
                    break;
                //LIST JobGroups
                ...
                case "3":
                    ...
                    createWorkers(sessionInfo, workers, jobId);

                    //DELETE TASK
            case "4":
                System.out.print("Which Job do you want to delete? ");
                if(!sessionInfo.getSessionRI().listJobGroups().isEmpty()) {
                    System.out.println(sessionInfo.getSessionRI().listJobGroups());
                }
                jobId = myObj.nextInt();
                this.factoryRI.getDb().removeJobGroup(jobId);
            ...
            case "5":
                ...
                jobId = myObj.nextInt();
                this.factoryRI.getDb().getJobGroup(jobId).changeState(2);
                break;
            //LOGOUT
            case "6":
    ...
    private void createWorkers(SessionInfo sessionInfo, int workers, int jobId) throws RemoteException {
