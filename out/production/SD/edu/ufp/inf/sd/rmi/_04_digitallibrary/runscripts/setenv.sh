...
#@REM =====================================================================================================
# @REM ==== PC STUFF ====
export JDK=/System/Library/Java/JavaVirtualMachines/jdk-15.0.2.jdk/Contents/Home
...
export USERNAME=jorgesilva

#@REM ==== JAVA NAMING STUFF ====
export JAVAPROJ_NAME=SD
export JAVAPROJ=/Users/${USERNAME}/Desktop/FAC/2_SEMESTRE/Sistemas_Distribuidos/PL/${JAVAPROJ_NAME}

export PACKAGE=_04_digitallibrary
